...
const Journey = () => {
  return (
    <TransitionInSection>
      <div
        className="flex flex-col justify-evenly min-[1280px]:flex-row"
        id="journey"
      >
        <img
          src={fun}
        ...
        <div className="flex flex-col items-center justify-center gap-4 p-12 text-center">
          ...
          <div className="text-left">
            <p>
              ...
              After exploring different paths, I eventually returned to software
              engineering and built my career around creating web applications.
              Today, I combine my frontend expertise with backend and cloud
              experience to build complete, scalable solutions.
            </p>
          </div>
          <br />
        </div>
