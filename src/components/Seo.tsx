...
const routeMeta: Record<string, { title: string; description: string; keywords: string }> = {
  '/': {
    ...
    keywords: 'Andrew Cosmic, frontend engineer, full stack engineer, React developer, Kent Washington',
  },
  '/synonyms': {
    title: 'Synonym Search App | Andrew Cosmic',
    description: 'Search for synonyms quickly with a lightweight React app built by Andrew Cosmic.',
    keywords: 'synonym search, React app, Andrew Cosmic',
  },
  '/memory-game': {
    title: 'Memory Game | Andrew Cosmic',
    description: 'Play a polished memory matching game built in React by Andrew Cosmic.',
    keywords: 'memory game, React game, Andrew Cosmic',
  },
  '/todo': {
    title: 'Todo App | Andrew Cosmic',
    description: 'A simple todo app experience built with React and TypeScript by Andrew Cosmic.',
    keywords: 'todo app, React todo, Andrew Cosmic',
  },
  '/color-guesser': {
    title: 'Color Guesser Game | Andrew Cosmic',
    description: 'Guess the color values in this interactive React color game by Andrew Cosmic.',
    keywords: 'color guesser, React game, Andrew Cosmic',
  },
};

const setMetaTag = (tagName: string, attributes: Record<string, string>, value?: string) => {
  let tag = document.querySelector(`${tagName}[${Object.keys(attributes)[0]}="${Object.values(attributes)[0]}"]`);
