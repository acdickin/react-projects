        ...
        <div>
            ...
            <div className="heroBanner" style={{ display: 'flex' }}>
                <div className='center-align'>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', flexWrap: 'wrap' }}>
                        <button className="language-buttons">React</button>
                        <button className="language-buttons">Tailwaind</button>
                    ...
                    <p style={{ padding: '0 40px' }}>Liveperson  knowledge center site. Helps users understand how they can use liverspon converstational cloud  </p>
