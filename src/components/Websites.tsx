...
const Websites = () => {
  return (
    <div className="flex flex-col gap-8" id="websites">
      <h2 className="text-2xl font-bold md:text-3xl">Websites</h2>

      <a
        href="https://myexercisebuddy.netlify.app/"
        target="_blank"
        className="block overflow-hidden p-12 shadow-xl transition-shadow hover:shadow-2xl"
      >
        <TransitionInSection>
          <img
            src={exerciseBuddy}
      ...
      <a
        ...
        target="_blank"
        className="block overflow-hidden p-12 shadow-lg transition-shadow hover:shadow-xl"
      >
        <TransitionInSection direction="right">
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <p className="px-10">
              ...
              accounts, log in, and chat with other users in real-time. It uses
